    ...
    <div class="container">
      <div class="left-section">
        <div class="inner-content">
          ...
          <p class="subheading">{{ $language('존재하지 않는 페이지입니다.') }}</p>
          <p class="subheading2">
            <router-link :to="mainUrl" class="bullshit__return-home">{{
              $language('메인화면으로 이동')
            }}</router-link>
          </p>
        </div>
...
.page404
  ...
  .svgimg
    ...
    .bottom-bench path:nth-child(1)
      fill: rgb(66.7559701493, 45.4820895522, 31.5440298507)
    .lamp-details
      fill: $gray
    .lamp-accent
      fill: rgb(43.8260869565, 49.3043478261, 50.6739130435)
    .lamp-bottom
