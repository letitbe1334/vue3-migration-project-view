        ...
        { 
          ...
          items: [
            ...
            },
            {
              title: 'Node.js',
              techs: [
                { name: 'Node.js 22', pick: true, description: `최신 기능과 최적화가 적용된 현재 LTS 버전으로, fetch API와 같은 최신 웹 표준을 기본으로 지원하며, V8 엔진 업데이트를 통해 성능을 극대화하여 개발 생산성과 애플리케이션의 실행 속도를 높여줍니다.` },
